...
```javascript
import dataset from 'https://cdn.jsdelivr.net/gh/stdlib-js/datasets-pace-boston-house-prices@v0.2.3-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/datasets-pace-boston-house-prices/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/datasets-pace-boston-house-prices/actions/workflows/test.yml?query=branch:v0.2.3
